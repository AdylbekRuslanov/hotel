...
if(isset($_POST['submit'])){
   ...
   if($select_admins->rowCount() > 0){
      $warning_msg[] = 'Такой user уже существует!';
   }else{
      if($pass != $c_pass){
         $warning_msg[] = 'Пароль не соответствует!';
      }else{
...
<section class="form-container">
   ...
   <form action="" method="POST">
      ...
      <input type="submit" value="регистрация" name="submit" class="btn">
   </form>
