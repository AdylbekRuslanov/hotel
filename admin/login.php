...
if(isset($_POST['submit'])){
   ...
   if($select_admins->rowCount() > 0){
      ...
      $warning_msg[] = 'Неправильный логин или пароль!';
   }
...
<section class="form-container" style="min-height: 100vh;">
   ...
   <form action="" method="POST">
      ...
      <p> Имя по умолчанию <span>admin</span> & password = <span>111</span></p>
      ...
      <input type="submit" value="войти в систему" name="submit" class="btn">
   </form>
