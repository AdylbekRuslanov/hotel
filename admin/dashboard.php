...
<section class="dashboard">
   ...
   <h1 class="heading">Панель админа</h1>
   ...
   <div class="box">
      ...
      <p>Количество брони</p>
      <a href="bookings.php" class="btn">просмотр брони</a>
   </div>
   ...
   <div class="box">
      ...
      <a href="admins.php" class="btn">просмотр админов</a>
   </div>
   ...
   <div class="box">
      ...
      <p>Авторизация или регистрация</p>
      <a href="login.php" class="btn" style="margin-right: 1rem;">авториз.</a>
      <a href="register.php" class="btn" style="margin-left: 1rem;">регистр</a>
   </div>
